...
const rangeLabelClasses = 'block mb-2 text-sm font-medium text-neutral-900 dark:text-white'
...
export function useRangeClasses(props: UseRangeClassesProps) {
  const rangeClasses = computed(() =>
    simplifyTailwindClasses(rangeDefaultClasses, rangeSizeClasses[props.size.value])
  )
