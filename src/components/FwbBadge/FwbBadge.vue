<template>
  <span
    v-if="show"
    class="inline-flex items-center px-2 py-1 me-2 text-sm font-medium text-red-800 bg-red-100 dark:bg-red-900 dark:text-red-300"
    :class="circular ? 'rounded-full' : 'rounded'"
  >
    {{ text }}
    <button
      v-if="closable"
