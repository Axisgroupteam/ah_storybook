...
const defaultTabClasses: TabClassMap = {
  default:
    'cursor-pointer inline-block p-4 rounded-t-lg hover:text-neutral-600 hover:bg-neutral-50 dark:hover:bg-neutral-800 dark:hover:text-neutral-300',
  active:
    'cursor-pointer inline-block p-4 text-red-600 bg-neutral-100 rounded-t-lg active dark:bg-neutral-800 dark:text-red-500',
  disabled:
...
const pillsTabClasses: TabClassMap = {
  default:
    'cursor-pointer inline-block py-2 px-4 rounded-lg hover:text-neutral-900 hover:bg-neutral-100 dark:hover:bg-neutral-700 dark:hover:text-white',
