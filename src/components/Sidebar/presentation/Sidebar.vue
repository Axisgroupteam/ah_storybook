<template>
  <aside
    ...
    :class="showDrawer ? 'translate-x-0 max-w-[1000px]' : '-translate-x-full'"
    aria-label="Sidenav"
  >
    <div
      ...
      @click.stop
    >
      <div class="flex flex-col px-3 min-w-[36px] pt-[20px] gap-[24px]">
        <fwb-tooltip
        ...
        >
          <template #trigger>
            <div
              class="flex justify-between items-center rounded-lg px-[8px] relative bg-red-100 dark:bg-red-900"
              :class="[{ 'w-[224px] py-3': showDrawer }, { 'w-fit py-4': !showDrawer }]"
            >
...
const menuItems = [
  ...
  {
    icon: 'dashboard',
    title: 'Drawer Item 13',
    name: 'manager'
  },
  {
    icon: 'dashboard',
    title: 'Drawer Item 14',
    name: 'manager'
  },
  {
    icon: 'dashboard',
    title: 'Drawer Item 15',
    name: 'manager'
  },
  {
    icon: 'dashboard',
    title: 'Drawer Item 16',
    name: 'manager'
  },
  {
    icon: 'dashboard',
    title: 'Drawer Item 17',
    name: 'manager'
  },
  {
    icon: 'dashboard',
    title: 'Drawer Item 18',
    name: 'manager'
  },
  {
    icon: 'dashboard',
    title: 'Drawer Item 19',
    name: 'manager'
  },
  {
    icon: 'dashboard',
    title: 'Drawer Item 20',
    name: 'manager'
  },
  {
    icon: 'dashboard',
    title: 'Drawer Item 21',
    name: 'manager'
  },
  {
    icon: 'dashboard',
    title: 'Drawer Item 22',
    name: 'manager'
  },
  {
    icon: 'dashboard',
    title: 'Drawer Item 23',
    name: 'manager'
  },
  {
    icon: 'dashboard',
    title: 'Drawer Item 24',
    name: 'manager'
  }
]
</script>
