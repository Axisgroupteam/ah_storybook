<template>
    <aside
      ...
      class="fixed top-[64px]  left-0 z-10 w-[250px]   bg-white border-r border-gray-200 dark:bg-neutral-800 dark:border-neutral-700 transition-all"
      :class="
        showDrawer
          ? 'translate-x-0 max-w-[1000px]'
          : '-translate-x-0 max-w-[60px]'
      "
      aria-label="Sidenav"
    >
      <div
      ...
      >
        ...
        <fwb-tooltip
            ...
            <AppSelectDropBox v-else class="w-full " :show-drawer="showDrawer" :options="moduleObject"/>
