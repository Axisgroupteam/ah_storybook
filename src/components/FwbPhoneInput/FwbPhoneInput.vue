    ...
    >
      ...
      <div class="relative w-full">
        <input
          ...
          :class="[disabled ? 'cursor-not-allowed bg-neutral-100 placeholder-neutral-400 dark:placeholder-neutral-500' : '',validationStatus === 'error' ? '!border-red-500 !bg-red-50 !text-red-900 !placeholder-red-700 dark:!text-red-500 dark:!placeholder-red-500 dark:!bg-neutral-700' : '']"
