<template >
  <fwb-dropdown  @toogle="handleToggle">
    <template #trigger >
      <fwb-tooltip
        placement="right"
        :active="!showDrawer"
      ...
      > 
        <template #trigger>
          <div   class="   flex justify-between ring-red-200 dark:ring-red-800   items-center rounded-lg px-[8px] relative bg-red-100 dark:bg-red-900"
            :class="[{'ring-[3px]': opened},
                      {'ring-0': !opened},
    ...
    <ul>
        <li v-for="i in dropdownOptions" class="px-4 items-center  text-xl overflow-x-clip w-[224px] py-4  flex gap-2 border-b whitespace-nowrap border-b-neutral-200 dark:border-b-neutral-600 last:border-b-0 hover:bg-neutral-100 hover:dark:bg-neutral-600 cursor-pointer first:rounded-t-lg justify-start last:rounded-b-lg text-neutral-500 hover:text-neutral-900 dark:hover:text-white dark:text-neutral-400  font-medium"
