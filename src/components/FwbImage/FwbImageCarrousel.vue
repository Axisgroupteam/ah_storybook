<template>
  ...
  >
    <template v-slot:prev-btn="{ prev }">
      <button
        class="absolute left-0 top-1/2 transform -translate-y-1/2 pl-4"
        @click="prev"
      >
        <span
    ...
    <template v-slot:next-btn="{ next }">
      <button
        class="absolute right-0 top-1/2 transform -translate-y-1/2 pr-4"
        @click="next"
      >
        <span
...
import ChevronGallery from "@/assets/flowbite_icons/chevron-gallery.svg";
