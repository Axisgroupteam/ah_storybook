  ...
  <div>   
    ...
    <div v-if="previewImages.length > 0" class="flex relative items-center align-middle my-5 text-base text-neutral-900">
      <span @click="scrollLeft" class="flex obsolute items-center justify-center w-10 h-10 rounded-full bg-neutral-200 hover:bg-neutral-300 cursor-pointer transition-all ease-in-out duration-150 right-0">
        ...
        <span @click="scrollRight" class="flex obsolute items-center justify-center w-10 h-10 rounded-full bg-neutral-200 dark:bg-neutral-700 hover:bg-neutral-300 hover:dar:neutral-800 cursor-pointer transition-all ease-in-out duration-150 right-0">
